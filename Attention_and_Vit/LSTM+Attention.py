...
train_dataset = torchvision.datasets.FashionMNIST(root='./datasets', train=True, download=False, transform=tranform)
val_dataset = torchvision.datasets.FashionMNIST(root='./datasets', train=False, download=False, transform=tranform)
